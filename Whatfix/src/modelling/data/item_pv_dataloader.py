...
import numpy as np
import random
from src.modelling.data.data_batching import ItemPVBatch
...
class ItemPVDataloader(DataLoader):
    ...
    def get_test_batch(self, batch):
        ...
        candi_prod_idxs = pad(candi_prod_idxs, pad_id = self.prod_pad_idx)
        candi_u_item_idxs = pad(candi_u_item_idxs, pad_id = self.prod_pad_idx)
    ...
    def get_test_batch_seq(self, batch):
        ...
        candi_prod_idxs = pad(candi_prod_idxs, pad_id = -1)
    ...
    def get_train_batch(self, batch):
        ...
        batch_u_item_idxs = pad(batch_u_item_idxs, pad_id = self.prod_pad_idx)
    ...
    def get_train_batch_ui_seq(self, batch):
        ...
        pos_seq_item_idxs = pad(pos_seq_item_idxs, pad_id = self.prod_pad_idx)
        ...
        neg_seq_item_idxs = pad_3d(neg_seq_item_idxs, pad_id = self.prod_pad_idx, dim=2)
